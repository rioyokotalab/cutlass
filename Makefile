...
CXX_FLAGS = -fPIC
CUDA_FLAGS = --generate-code=arch=compute_90a,code=[sm_90a] --generate-code=arch=compute_90a,code=[compute_90a] -Xcompiler=-fPIC --expt-relaxed-constexpr -std=c++20 -Xcompiler="-fPIC -Wconversion -fno-strict-aliasing"
